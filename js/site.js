...
document.addEventListener('DOMContentLoaded', () => {
  loadSiteData()
    ...
    .catch(err => {
      ...
      const footerRoot = document.getElementById('footer-root');
      if (footerRoot) {
        footerRoot.innerHTML = '<p style="text-align:center; padding:1rem;">Site content failed to load. If you\'re opening this file directly, run it through a local server instead — browsers block JSON fetches from local files.</p>';
      }
    });
});